...
public class InMapperWordCount extends Configured implements Tool {
	...
	public static class Map extends Mapper<LongWritable, Text, Text, IntWritable> {
        ...
        private HashMap<Text, IntWritable> H = new HashMap<Text, IntWritable>();
	        ...
	        while (matcher.find()) {
	            ...
	            if (!w.contains(".")) {
	                ...
	                if (!H.containsKey(word)) {
		            	...
		            	int val = H.get(word).get();
		            	H.put(word, new IntWritable(val+1));
		            }
	            }
	        }
	    }
	    ...
	    public void cleanup(Context context) throws IOException, InterruptedException {
	        for (Entry<Text, IntWritable> entry : H.entrySet()) {
