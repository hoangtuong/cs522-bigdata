...
/**
 * This class refactors the class PairOfStrings of Jimmy Lin's Cloud9 Map-Reduce
 * librarry (http://lintool.github.com/Cloud9), to make it more flexible to
 * other frameworks.
 * 
 * @author tuan
 * 
...
public class StringPairWritable implements
	...
	public boolean equals(Object obj) {
		if (obj == this)
			return true;
		else if (obj == null || !(obj instanceof StringPairWritable))
			return false;
		StringPairWritable pair = (StringPairWritable) obj;
		return leftElement.equals(pair.getLeft())
				&& rightElement.equals(pair.getRight());
	}
	...
	public int compareTo(StringPairWritable pair) {
		String pl = pair.getLeft();
		String pr = pair.getRight();
	...
	public static class Comparator extends WritableComparator {
		...
		/**
		 * Creates a new Comparator optimized for
		 * <code>StringPairWritable</code>.
		 */
		public Comparator() {
